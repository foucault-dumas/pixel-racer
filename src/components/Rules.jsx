...
export default function Rules({close}) {
  return <>
    ...
    <ol className="rules-list">
      <li><strong>Place-toi et joue dans la foulée.</strong>Pose ton point sur la ligne, puis joue immédiatement ton premier coup : un carreau maximum, diagonales comprises. Ensuite seulement, passe le Bic au suivant.</li>
